...
# mkdir -p yolov7-np
# download_file_if_not_exists "./yolov7-np/LP_detect_yolov7_500img.pt" "https://github.com/mrzaizai2k/License-Plate-Recognition-YOLOv7-and-CNN/releases/download/Model/LP_detect_yolov7_500img.pt"
